...
<body>
    ...
    Sie wurden als Benutzer mit der Nummer <strong><?php echo $_SESSION['kundeId']; ?></strong> erfolgreich angemeldet.<br />
    Ihre jetzige Session <code><?php echo $_SESSION['sessionId']; ?></code> wird beendet.<br />
